 ...
 *
 * NOTE: This class needs updating to port it from io.jsonwebtoken to com.auth0.jwt
 * 
 * @author rcardone
 */
...
//    private static final Algorithm sigAlg = Algorithm.RSA256();
...
//                              signWith(privateKey, signatureAlg).compact();
    ...
    /**
     * Get the private key from the default tapis keystore associated with an  alias.
     * The alias is specified as an input parameter.
     *
     ...
     * @throws TapisException on error
     */
    private void outputJwt(String encodedJwt) throws TapisException
    {
