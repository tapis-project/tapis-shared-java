...
public final class CreateJWTParameters 
{
  ...
  /* constructor:                                                           */
  /* ---------------------------------------------------------------------- */
  public CreateJWTParameters(String[] args) throws Exception
  {
  ...
  private void initializeParms(String[] args) throws Exception
  {
    ...
    catch (CmdLineException e)
    {
      if (!help)
      {
        ...
        try {writer.write(ostream.toString(Charset.defaultCharset()));}
