...
public class ASTParserTest
{
  ...
  public void testASTParseValid()
  {
    ...
    validCaseInputs.put(  9,new CaseData(2, "name NLIKE 'testname%'"));
    validCaseInputs.put( 10,new CaseData(2, "name NOT LIKE 'testname_'"));
    validCaseInputs.put( 11,new CaseData(2, "port BETWEEN '0' AND '1024'"));
    validCaseInputs.put( 12,new CaseData(2, "port NBETWEEN '0' AND '1024'"));
    validCaseInputs.put( 13,new CaseData(2, "port NOT BETWEEN '0' AND '1024'"));
    validCaseInputs.put( 14,new CaseData(2, "owner IN ('jdoe', 'msmith')"));
    validCaseInputs.put( 15,new CaseData(2, "owner NIN ('jdoe', 'msmith')"));
    validCaseInputs.put( 16,new CaseData(2, "owner NOT IN ('jdoe', 'msmith')"));
