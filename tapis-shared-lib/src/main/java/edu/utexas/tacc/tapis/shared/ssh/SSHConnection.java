...
public class SSHConnection 
{
    ...
    private void initSession() throws TapisException, IOException 
    {
        ...
        _session = _client.connect(_username, _host, _port)
                   .verify(_timeouts.getConnectTime(), _timeouts.getConnectUnits())
                   .getSession();
        ...
        // Authenticate the user.
        _session.auth().verify(_timeouts.getAuthenticateTime(), _timeouts.getAuthenticateUnits());
    }
    ...
    /* getPublicKey:                                                          */
    /* ---------------------------------------------------------------------- */
    private PublicKey getPublicKey() throws TapisSecurityException
    {
