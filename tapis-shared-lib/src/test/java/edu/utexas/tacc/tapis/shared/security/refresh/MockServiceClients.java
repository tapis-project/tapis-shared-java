...
/** This class is a copy of the ServiceClient altered for testing the token 
 * refresh process by referencing MockServiceContext instead of the original
...
public class MockServiceClients 
{
	...
	/* ********************************************************************** */
	// Tracing.
	private static final Logger _log = LoggerFactory.getLogger(MockServiceClients.class);
	...
	{
		private static final MockServiceClients _instance = new MockServiceClients(); 
	}
	...
	/* getInstance:                                                           */
	/* ---------------------------------------------------------------------- */
	public static MockServiceClients getInstance() {return SingletonInitializer._instance;}
     ...
     throws RuntimeException, TapisException, ExecutionException
	{
        ...
        if (MockServiceContext.getInstance().hasRefreshedTokens()) _clientCache.invalidateAll();
     ...
     throws RuntimeException, TapisException
    {
        ...
        var router = MockServiceContext.getInstance().getRouter(tenant, service);
